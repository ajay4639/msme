...
let headConfig = require('./head-config.common');
...
module.exports = function (options) {
  ...
  for (let rel in headConfig.link) {
    rel.href = METADATA.baseUrl + rel.href;
  }
  //START:--Added by AJAY
  // const bootstrapCustomLocation = process.env.BOOTSTRAPRC_LOCATION;
  const bootstrapCustomLocation = ".bootstraprc";
  let bootstrapEntryPoint = void 0;
  // if (isProd) {
  //   bootstrapEntryPoint = "bootstrap-loader/lib/bootstrap.loader?extractStyles&configFilePath=" + __dirname + "/" + bootstrapCustomLocation + "!bootstrap-loader/no-op.js";
  // } else {
  //   bootstrapEntryPoint = "bootstrap-loader/lib/bootstrap.loader?configFilePath=" + __dirname + "/" + bootstrapCustomLocation + "!bootstrap-loader/no-op.js";
  // }
  bootstrapEntryPoint = "bootstrap-loader/lib/bootstrap.loader?configFilePath=" + __dirname + "/" + bootstrapCustomLocation + "!bootstrap-loader/no-op.js";
  //END:--Added by AJAY
  const entry = {
    polyfills: './src/polyfills.browser.ts',
    twbs: bootstrapEntryPoint,
  ...
  return {
            ...
            'to-string-loader', 'css-loader', 'sass-loader',
            {
              ...
              options: {
                ...
                resources: [
                  ...
                  helpers.root('src', 'styles/_mixins.scss'),
                  helpers.root('src', 'styles/_functions.scss')
                ]
              }
            }
          ],
    ...
    plugins: [
      ...
      */
       ...
       */
      new HtmlElementsPlugin({
        headTags: headConfig //require('./head-config.common')
      }),
